« *Mais où est donc ce satané Otomaï, toujours caché dans son arbre ? Et vais-je avoir toutes les captures requises afin de compléter mon étape de l'Eternelle Moisson ?* »

Si vous vous êtes déjà retrouvés dans cette situation, alors **Moisson Rouge** est faite pour vous.
